...
export default function StudentSecurityPage() {
    ...
    const handleChangePassword = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response = await fetch(`${baseUrl}/auth/settings/change-password/`, {
                method: "POST",
                headers: {
    ...
    return (
        <div className="space-y-8">
            <div>
                ...
                <p className={isLight ? "text-slate-500" : "text-white/60"}>Manage your password and account security settings.</p>
            </div>
                ...
                <SettingsCard variant={variant}>
                    <form onSubmit={handleChangePassword}>
                        <SettingsCardContent className="space-y-6">
                            ...
                            {notification && (
                                <div className={cn(
                                    "p-4 border rounded-xl flex items-center gap-3 animate-in fade-in slide-in-from-top-2 duration-300",
                            ...
                            {/* Current Password */}
                            <div>
                                <Label htmlFor="currentPassword" className={isLight ? "text-slate-900" : "text-white"}>Current Password</Label>
                                <div className="relative mt-2">
                                    ...
                                    <Input
                                        ...
                                        className={cn(
                                            "pl-10 pr-10",
                                            isLight ? "bg-white border-slate-200 text-slate-900 placeholder:text-slate-400" : "bg-black/20 border-white/10 text-white placeholder:text-white/30",
                        ...
                        <SettingsCardFooter variant={variant} className="flex justify-end border-t border-slate-200 dark:border-white/10 pt-4 mt-4">
                            <Button
                                type="submit"
                                disabled={isLoading}
                                className={cn(
                                    "px-6 shadow-md transition-all hover:scale-[1.02]",
